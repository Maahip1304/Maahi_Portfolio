      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {skillCategories.map((category, index) => (
            ...
            >
              <Card className={`bg-gradient-to-br from-slate-800/70 via-slate-800/50 to-slate-900/70 border ${category.borderColor} backdrop-blur-sm p-8 hover:bg-slate-800/80 transition-all duration-500 transform hover:scale-[1.02] hover:shadow-2xl hover:shadow-emerald-400/10 h-full`}>
...
const SkillItem = ({ skill, delay, isVisible }) => (
  ...
  >
    <Badge 
      variant="secondary" 
      className="w-full justify-center p-3 text-base bg-slate-700/50 text-gray-300 hover:bg-gradient-to-r hover:from-emerald-500/20 hover:to-cyan-600/20 hover:text-emerald-300 transition-all duration-300 border border-slate-600/50 hover:border-emerald-400/30"
    >
      {skill}
    </Badge>
  </div>
